...
fai=39.4; %纬度
h=80; o=1;
x=readmatrix('坐标41.xlsx','Range','A1:A1494');
y=readmatrix('坐标41.xlsx','Range','B1:B1494');
z=readmatrix("坐标41.xlsx",'Range','C1:C1494');
l=readmatrix("坐标41.xlsx",'Range','D1:D1494');
w=readmatrix("坐标41.xlsx",'Range','E1:E1494');
sa=zeros(12,5);
sb=zeros(12,5);
DNI=zeros(1,60);
N=length(x);
...
repsun3=psun3/sum(A);
repsun=psun/sum(A)*1000;
for i=1:12
    fprintf('%.d月21日平均光学效率为%f\n',i,yita3(i));
    fprintf('%d月21日平均阴影遮挡效率为1\n',i);
